...
public class SMCKit : NSObject{
    ...
    public  func keyCount() throws -> Int {
        let key = SMCKey(code: FourCharCode(fromString: "#KEY"),
    ...
    public  func fanCount() throws -> Int {
        let key = SMCKey(code: FourCharCode(fromString: "FNum"),
    ...
    public  func isOpticalDiskDriveFull() throws -> Bool {
        ...
        let key = SMCKey(code: FourCharCode(fromString: "MSDI"),
                         info: DataTypes.Flag)
    ...
    public  func batteryInformation() throws -> batteryInfo {
        let batteryCountKey =
            SMCKey(code: FourCharCode(fromString: "BNum"),
                   info: DataTypes.UInt8)
        let batteryPoweredKey =
            SMCKey(code: FourCharCode(fromString: "BATP"),
                   info: DataTypes.Flag)
        let batteryInfoKey =
            SMCKey(code: FourCharCode(fromString: "BSIn"),
                   info: DataTypes.UInt8)
